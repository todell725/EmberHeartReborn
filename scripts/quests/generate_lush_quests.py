...
# Template for generating quest turns and the overall structure
...
quests.append(create_quest("EH_SQ_022", "The Lantern's Ghost", "A streetlamp is projecting haunting memories onto the streets of the High-Ward...", q22_turns, {"loot": ["Lantern-Charm", "Liquid-Memory Vial"], "xp": 210}, "Your own memories are deleted by the Eaton. (Quest Failed)"))
...
q25_turns = [
    ...
    ("The Warehouse is quiet, the fabric once again just fabric. The 'Golden-Needle' is back in its velvet box.", "Log the experience", "Accept the gold", "The sun sets, its light hit the silver-silk of the scarf in a corona of white light."),
...
q26_turns = [
    ...
    ("A 'Barrel-Beast'—a construct of wood-staves and iron-hoops—is 'Protecting' the oozing wine with a roar of escaping gas.", "Battle the Beast", "Douse the fire with the purple wine", "The wine is actually 'Fire-Retardant' mana. It extinguishes the beast’s 'Internal-Pilot-Light'. (+1 Progress)"),
    ("The floor of the cellar is dissolving into 'Purple-Mud'. You find a 'Void-Flask' at the bottom of the vat.", "Retrieve the flask", "Drain the mud", "The flask contains the 'Essence of a Lost-Summer'—a liquid that can heal any mental scar. (+1 Loot)"),
    ...
    ("The 'Barrel-Beast' reforms, but its eyes are now soft blue. It’s 'Tame'. It offers you its 'Master-Hoop' as a shield.", "Accept the hoop", "Smash the construct", "The hoop is made of 'Void-Iron' and reflects all magical attacks. (+1 Gear)"),
...
q27_turns = [
    ...
    ("A 'Static-Weaver'—a tiny spider made of blue silk and sparks—is 'Knitting' the laundry into a giant, electric web.", "Wipe out the web", "Befriend the spider with mana", "The spider gives you a 'Blue-Silk-Scrap'—it can hold a charge of 50 volts. (+1 Loot)"),
    ("The 'Laundry-Master' is trapped under a 'Heated-Quilt' that is trying to 'Cook' him with mana-heat.", "Douse the quilt with water", "Reverse the quilt's polarity (Tech DC 13)", "The quilt becomes a 'Cooling-Cape'. The air in the ward drops twenty degrees in a second. (+1 Progress)"),
    ...
    ("The Laundry-Master gives you a 'Safety-Pin of Grounding'—it makes you immune to basic electric shocks.", "Accept the pin", "Take the Blue-Silk", "The pin is made of brass and glows when near high-voltage. (+1 Gear)"),
...
q28_turns = [
    ...
    ("The ink is 'Living-Script'—it’s crawling off the page and trying to write a 'New-Story' on your own skin.", "Wipe the ink away", "Allow the script to finish (Wis DC 14)", "The script reveals a 'Secret-Passage' behind the 'Law-Section'. (+1 Lore)"),
    ("A 'Book-Wyrm'—a creature of paper-scales and leather-wings—is eating the 'Forgotten-Lore' in the restricted section.", "Slash the Wyrm", "Feed the Wyrm a 'Blank-Book'", "The Wyrm burps a 'Cinder-Shard' and vanishes into the vents. You find a 'Lost-Page' on the floor. (+1 Loot)"),
    ("The 'Librarian'—a woman in glasses made of 'Void-Glass'—is frantic. 'The books... they’re rewriting the laws of gravity!' she cries.", "Anchor the bookshelves", "Consult the 'Master-Tome'", "The books begin to float, forming a 'Spiral-Staircase' of knowledge into the ceiling-void. (+1 Progress)"),
    ...
    ("The Librarian gives you a 'Bookmark of Holding'—it can save your place in any dimension. (+1 Gear).", "Accept the bookmark", "Take the Lost-Page", "The bookmark is made of red silk and never frays. It’s a 'Logic-Anchor'."),
...
q29_turns = [
    ("The scrap-yard is infested with 'Shadow-Rats'—vermin that can walk through walls and eat your 'Potential'.", "Set a shadow-trap", "Bait them with 'Warp-Scraps'", "The rats are translucent and smell of wet fur and ozone. They chitter in a frequency that makes you feel 'Unlucky' (-1 Luck)."),
    ...
    ("The scrapyard floor is riddled with 'Shadow-Holes'—small rifts that swallow your gear if you're not careful.", "Level the ground (Str DC 12)", "Navigate the piles (Dex DC 13)", "You find a 'Lost-Pocket-Watch' in a hole. It’s still ticking, but backward. (+1 Loot)"),
...
q30_turns = [
    ...
    ("The well-water is turning into 'Liquid-Lead'. It’s becoming too heavy to drink and is 'Crushing' the local pipes.", "Purify the well with 'Materia-Salt'", "Reverse the well's flow (Tech DC 13)", "The water boils and then turns into 'Crystal-Flow'—an eternal, cold supply of pure mana-water. (+1 Progress)"),
    ...
    ("The Wellminder promises to 'Guard the Dreams' of the town. He offers you a 'Well-Token' which entitles you to one 'Re-roll' per week.", "Accept the token", "Decline reward", "The sun sets, its light hit the well-water in a corona of liquid diamonds."),
