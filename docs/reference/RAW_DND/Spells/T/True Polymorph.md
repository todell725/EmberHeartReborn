# [True Polymorph](https://www.dndbeyond.com/spells/2619198-true-polymorph)

#Level9 #Transmutation ( #Bard, #Warlock, #Wizard)
...
The target gains a number of [Temporary Hit Points](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#TemporaryHitPoints) equal to the Hit Points of the new form. These Tempo- rary Hit Points vanish if any remain when the spell ends.
