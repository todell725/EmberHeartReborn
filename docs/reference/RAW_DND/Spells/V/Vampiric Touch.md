# [Vampiric Touch](https://www.dndbeyond.com/spells/2619214-vampiric-touch)

#Level3 #Necromancy ( #Sorcerer, #Warlock, #Wizard)
...
Until the spell ends, you can make the attack again on each of your turns as a [Magic](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#MagicAction) action, targeting the same creature or a different one.
