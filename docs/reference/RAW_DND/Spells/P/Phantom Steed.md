...
For the duration, you or a creature you choose can ride the steed. The steed uses the [Riding Horse](https://www.dndbeyond.com/monsters/4775839-riding-horse) stat block (see [appendix B](https://www.dndbeyond.com/sources/dnd/phb-2024/creature-stat-blocks#RidingHorse)), except it has a Speed of 100 feet and can travel 13 miles in an hour. When the spell ends, the steed gradually fades, giving the rider 1 minute to dismount. The spell ends early if the steed takes any damage.