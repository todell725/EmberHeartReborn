# [Find the Path](https://www.dndbeyond.com/spells/2618881-find-the-path)

#Level6 #Divination ( #Bard, #Cleric, #Druid)
...
**Duration:** [Concentration](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#Concentration), up to 1 day
