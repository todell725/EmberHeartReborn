...
#Level6 #Necromancy ( #Warlock, #Wizard)
...
A creature that can see the sensor (such as one using [[See Invisibility]] or [truesight](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#Truesight)) sees a translucent image of the tormented humanoid whose soul you caged.