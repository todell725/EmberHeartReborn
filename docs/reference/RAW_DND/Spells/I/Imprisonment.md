# [Imprisonment](https://www.dndbeyond.com/spells/2619175-imprisonment)

#Level9 #Abjuration ( #Warlock, #Wizard)
...
**Chaining.** Chains firmly rooted in the ground hold the target in place. The target has the [Restrained](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#RestrainedCondition) condition and can’t be moved by any means.
...
**Slumber.** The target has the [Unconscious](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#UnconsciousCondition) condition and can’t be awoken.
